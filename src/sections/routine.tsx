  ...
  return (
    <section className="px-4 py-10 max-w-screen-xl mx-auto lg:px-22.5">
      <motion.div
        ...
        className="flex flex-col lg:flex-row-reverse justify-center lg:justify-between items-center"
      >
      ...
      <div className="flex flex-col gap-12 md:gap-20 lg:gap-24">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
          ...
          >
            <div className="size-6 flex justify-center items-center rounded-full bg-primary text-white font-black">
              1
            </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse gap-6 lg:gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.8 }}
            className="flex flex-col gap-2 justify-center lg:text-end"
          >
            <div className="size-6 flex justify-center items-center rounded-full bg-primary text-white font-black lg:self-end">
              2
            </div>
            <h2 className="text-xl md:text-2xl font-bold text-gray-600">
              AI 기반 단백질 루틴 설계
